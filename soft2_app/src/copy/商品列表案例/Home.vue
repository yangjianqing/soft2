    ...
    export default {
        ...
        data(){
            return {
                goodsList:[
                    ...
                    {id:4,num:1,name:"荣耀10青春版",price:1399,imgUrl:"https://labfile.oss.aliyuncs.com/courses/5428/young.jpg"},
                ],
                carList:[]
            }
        },
        ...
        methods:{
            ...
            addGoodsToCar(goods){
                ...
                // includes：判断对象是否已存在
                let siInclude = this.carList.includes(goods);
                if(siInclude){
                    goods.num+=1;
                }else{ //将子组件中传递出来的商品 添加到购物车列表
                        goods.num=1;
