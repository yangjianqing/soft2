  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="会员级别" prop="memberLevel">
        <el-select v-model="queryParams.memberLevel" placeholder="请选择会员级别" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="membersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="会员级别" align="center" prop="memberLevel">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.f_membership_grade" :value="scope.row.memberLevel"/>
        </template>
      </el-table-column>
      <el-table-column label="会员积分" align="center" prop="memberIntegration" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="会员级别" prop="memberLevel">
          <el-select v-model="form.memberLevel" placeholder="请选择会员级别">
            <el-option
              v-for="dict in dict.type.f_membership_grade"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="会员积分" prop="memberIntegration">
          <el-input v-model="form.memberIntegration" placeholder="请输入会员积分" />
        </el-form-item>
      </el-form>
...
<script>
import { listMembers, getMembers, delMembers, addMembers, updateMembers, initUsers } from "@/api/system/members";

export default {
  name: "Members",
  dicts: ['f_membership_grade'],
  data() {
    return {
      // 遮罩层
      loading: true,
